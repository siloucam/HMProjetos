...
public class ServicoResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllServicosByIptuIsEqualToSomething() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where iptu equals to DEFAULT_IPTU
        defaultServicoShouldBeFound("iptu.equals=" + DEFAULT_IPTU);

        // Get all the servicoList where iptu equals to UPDATED_IPTU
        defaultServicoShouldNotBeFound("iptu.equals=" + UPDATED_IPTU);
    }

    @Test
    @Transactional
    public void getAllServicosByIptuIsInShouldWork() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where iptu in DEFAULT_IPTU or UPDATED_IPTU
        defaultServicoShouldBeFound("iptu.in=" + DEFAULT_IPTU + "," + UPDATED_IPTU);

        // Get all the servicoList where iptu equals to UPDATED_IPTU
        defaultServicoShouldNotBeFound("iptu.in=" + UPDATED_IPTU);
    }

    @Test
    @Transactional
    public void getAllServicosByIptuIsNullOrNotNull() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where iptu is not null
        defaultServicoShouldBeFound("iptu.specified=true");

        // Get all the servicoList where iptu is null
        defaultServicoShouldNotBeFound("iptu.specified=false");
    }

    @Test
    @Transactional
    public void getAllServicosByLinkIsEqualToSomething() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where link equals to DEFAULT_LINK
        defaultServicoShouldBeFound("link.equals=" + DEFAULT_LINK);

        // Get all the servicoList where link equals to UPDATED_LINK
        defaultServicoShouldNotBeFound("link.equals=" + UPDATED_LINK);
    }

    @Test
    @Transactional
    public void getAllServicosByLinkIsInShouldWork() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where link in DEFAULT_LINK or UPDATED_LINK
        defaultServicoShouldBeFound("link.in=" + DEFAULT_LINK + "," + UPDATED_LINK);

        // Get all the servicoList where link equals to UPDATED_LINK
        defaultServicoShouldNotBeFound("link.in=" + UPDATED_LINK);
    }

    @Test
    @Transactional
    public void getAllServicosByLinkIsNullOrNotNull() throws Exception {
        // Initialize the database
        servicoRepository.saveAndFlush(servico);

        // Get all the servicoList where link is not null
        defaultServicoShouldBeFound("link.specified=true");

        // Get all the servicoList where link is null
        defaultServicoShouldNotBeFound("link.specified=false");
    }
