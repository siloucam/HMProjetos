...
public class ServicoQueryService extends QueryService<Servico> {
    ...
    private Specifications<Servico> createSpecification(ServicoCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getIptu() != null) {
                specification = specification.and(buildStringSpecification(criteria.getIptu(), Servico_.iptu));
            }
            if (criteria.getLink() != null) {
                specification = specification.and(buildStringSpecification(criteria.getLink(), Servico_.link));
            }
