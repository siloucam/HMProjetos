...
public class ServicoCriteria implements Serializable {
    ...
    private LongFilter codprefeituraId;

    private LongFilter linkexternoId;
    ...
    public LongFilter getCodprefeituraId() {
        return codprefeituraId;
    }

    public void setCodprefeituraId(LongFilter codprefeituraId) {
        this.codprefeituraId = codprefeituraId;
    }

    public LongFilter getLinkexternoId() {
        return linkexternoId;
    }

    public void setLinkexternoId(LongFilter linkexternoId) {
        this.linkexternoId = linkexternoId;
    }
    ...
    public String toString() {
        return "ServicoCriteria{" +
                ...
                (fim != null ? "fim=" + fim + ", " : "") +
                (codprefeituraId != null ? "codprefeituraId=" + codprefeituraId + ", " : "") +
                (linkexternoId != null ? "linkexternoId=" + linkexternoId + ", " : "") +
