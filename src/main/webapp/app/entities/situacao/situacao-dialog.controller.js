(function() {
    ...
    SituacaoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Situacao', 'Servico', 'ExtendUser'];

    function SituacaoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Situacao, Servico, ExtendUser) {
        var vm = this;
